...
You can then execute your native executable with: `./target/encryption-decryption-1.0.0-SNAPSHOT-runner`
...
- Camel Crypto (JCE) ([guide](https://camel.apache.org/camel-quarkus/latest/reference/extensions/crypto.html)): Sign and verify exchanges using the Signature Service of the Java Cryptographic Extension (JCE)
